...
public enum GerarAutomaticoCliente {
    ...
    CLIENTE_2("Maria Oliveira", new Data(1990, 2, 20), Genero.FEMININO, 987654321, "P987654", "maria.oliveira@email.com", 10.0),
    ...
    CLIENTE_4("Ana Pereira", new Data(1992, 8, 25), Genero.FEMININO, 223344556, "P223344", "ana.pereira@email.com", 15.0),
    ...
    CLIENTE_6("Cláudia Martins", new Data(1995, 6, 30), Genero.FEMININO, 445566778, "P445566", "claudia.martins@email.com", 5.0),
    ...
    CLIENTE_8("Fernanda Lima", new Data(1993, 3, 18), Genero.FEMININO, 667788990, "P667788", "fernanda.lima@email.com", 7.5),
    ...
    CLIENTE_10("Juliana Costa", new Data(1998, 7, 9), Genero.FEMININO, 889900112, "P889900", "juliana.costa@email.com", 0.0);
