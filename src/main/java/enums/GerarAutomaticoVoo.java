...
public enum GerarAutomaticoVoo {
    ...
    VOO1("AB123", CompanhiaAerea.EASYJET, 180, 50, 800.0, 300.0, new Data(2024, 11, 28), LocalTime.of(10, 30)),
    ...
    VOO2("CD456", CompanhiaAerea.TAP, 160, 40, 650.0, 250.0, new Data(2024, 12, 5), LocalTime.of(15, 45)),
    ...
    VOO3("EF789", CompanhiaAerea.LATAM, 200, 100, 1200.0, 350.0, new Data(2025, 12, 7), LocalTime.of(12, 0)),
    ...
    VOO4("GH012", CompanhiaAerea.AZUL, 220, 80, 1500.0, 450.0, new Data(2025, 12, 10), LocalTime.of(18, 0)),
    ...
    VOO5("IJ345", CompanhiaAerea.RYANAIR, 150, 75, 500.0, 200.0, new Data(2025, 12, 15), LocalTime.of(9, 15)),
    ...
    VOO6("KL678", CompanhiaAerea.AZUL, 190, 120, 1800.0, 500.0, new Data(2025, 1, 1), LocalTime.of(14, 30)),
    ...
    VOO7("MN901", CompanhiaAerea.EASYJET, 210, 60, 950.0, 375.0, new Data(2025, 2, 6), LocalTime.of(20, 0)),
    ...
    VOO8("OP234", CompanhiaAerea.RYANAIR, 170, 90, 1300.0, 420.0, new Data(2025, 3, 20), LocalTime.of(16, 15)),
    ...
    VOO9("QR567", CompanhiaAerea.TAP, 180, 60, 1100.0, 300.0, new Data(2025, 4, 6), LocalTime.of(8, 0)),
    ...
    VOO10("ST890", CompanhiaAerea.LATAM, 200, 50, 1400.0, 460.0, new Data(2025, 5, 10), LocalTime.of(11, 45));
